...
describe("doSaveJob Saga", () => {
  ...
  it("should save Job", () => {
    ...
    fakeJob["jobTitle"] = "Principal Directives Director";

    fakeJob["minSalary"] = 56430;

    fakeJob["maxSalary"] = 86108;
...
*/
  it("should handle reducer and store state", () => {
    ...
    fakeJob["jobTitle"] = "Forward Security Manager";

    fakeJob["minSalary"] = 30084;

    fakeJob["maxSalary"] = 45391;
