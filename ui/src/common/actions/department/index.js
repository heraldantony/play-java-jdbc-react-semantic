...
export const DEPARTMENT_SET_LOCATION = "department/Set_Location";
export const DEPARTMENT_DELETE_LOCATION = "department/Delete_Location";
...
export const DEPARTMENT_ADD_EMPLOYEE = "department/Add_Employee";
export const DEPARTMENT_DELETE_EMPLOYEE = "department/Delete_Employee";
