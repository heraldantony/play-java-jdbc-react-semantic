...
public class ApiAction extends play.mvc.Action.Simple {
    private final Logger.ALogger logger = play.Logger.of("application.ApiAction");
    ...
    @Singleton
    @Inject
    public ApiAction(MetricRegistry metrics, HttpExecutionContext ec, ActorSystem actorSystem) {
        this.ec = ec;
        this.requestsMeter = metrics.meter("requestsMeter");
        this.responsesTimer = metrics.timer(name(ApiAction.class, "responsesTimer"));
    }
